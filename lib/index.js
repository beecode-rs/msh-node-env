...
const MshNodeEnv = (params = {}) => {
    var _a, _b;
    const locationStrategy = (_a = params.locationStrategy) !== null && _a !== void 0 ? _a : new location_1.SimpleEnvLookup();
    const loggerStrategy = (_b = params.loggerStrategy) !== null && _b !== void 0 ? _b : new logger_1.NoLogger();
    return (name) => {
